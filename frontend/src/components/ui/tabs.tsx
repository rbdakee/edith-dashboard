...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn('inline-flex h-9 items-center justify-start rounded-lg bg-gray-800 p-1 text-gray-400 gap-1', className)}
    {...props}
  />
));
